...
urlpatterns.extend([
    ...
    path('manager/upload_history/', vm.UploadHistoryView.as_view(), name='upload_history'),
    ...
    path('manager/reward-requests/batch-save/',
         vm.BatchSaveRewardRequestsView.as_view(),
         name='reward_request_batch_save'),
